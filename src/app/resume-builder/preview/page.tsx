...
export default function FullPreviewPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] p-xl flex justify-center selection:bg-[#8B0000] selection:text-white">
      <div className="max-w-[800px] w-full space-y-xl">
        ...
        <header className="text-center space-y-md border-b-2 border-[#111111] pb-xl">
          ...
          <div className="flex justify-center gap-xl pt-md">
            {data.links.github && <span className="text-xs font-bold border-b border-[#111111]">{data.links.github}</span>}
            {data.links.linkedin && <span className="text-xs font-bold border-b border-[#111111]">{data.links.linkedin}</span>}
          </div>
        </header>
